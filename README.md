...
Map(Reshape) a csv file to the template format. What you need: an openai API key, a csv data file you want to reformat, a csv template file you want the target format to be like.
